              ...
              >
                ...
                <div className="prospect-card-main">
                  ...
                  <div className="prospect-card-title">
                    ...
                    {(category||city)&&
                      <small>
                        {[category,city].filter(Boolean).join(' Ã‚Â· ')}
                      </small>
                    }
                  </div>
                ...
                <div className="prospect-card-footer">
                  ...
                  <span className="prospect-chevron" aria-hidden="true">Ã¢â‚¬Âº</span>
                </div>
