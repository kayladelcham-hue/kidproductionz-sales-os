...
def campaigns(request: Request):
    ...
    for row in list_campaigns(_owner_id(request)):
...
def campaign_delete(campaign_id:str, request: Request):
    try:
        result = delete_campaign(campaign_id, _owner_id(request))
...
@app.get('/api/queue')
def queue(request: Request, campaign='orlando_beauty'):
...
def prospects(request: Request, campaign='orlando_beauty'):
    return list_prospects(campaign, _owner_id(request))
